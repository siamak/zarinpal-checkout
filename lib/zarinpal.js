 ...
 */
function ZarinPal(MerchantID, sandbox, extraRequestParams) {
 ...
 */
exports.create = function(MerchantID, sandbox, extraRequestParams) {
	return new ZarinPal(MerchantID, sandbox, extraRequestParams);
};
